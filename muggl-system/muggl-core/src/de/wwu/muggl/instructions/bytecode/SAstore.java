...
import de.wwu.muggl.instructions.typed.ShortInstruction;
import de.wwu.muggl.vm.classfile.ClassFile;

/**
 * Implementation of the instruction  <code>sastore</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-03-26
 */
public class SAstore extends Astore implements Instruction {

	/**
	 * Constructor to initialize the TypedInstruction.
	 */
	public SAstore() {
		 this.typedInstruction = new ShortInstruction();
	}
	...
	public byte[] getTypesPopped(ClassFile methodClassFile) {
		byte[] types = {ClassFile.T_INT, ClassFile.T_INT, 0};
		return types;
	}
