...
/**
 * Implementation of the instruction <code>ireturn</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-03-26
 */
public class IReturn extends de.wwu.muggl.instructions.general.ReturnWithValue implements Instruction {
