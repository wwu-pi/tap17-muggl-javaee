...
/**
 * Implementation of the instruction  <code>aload</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-03-26
 */
public class ALoad extends Load implements Instruction {
	 ...
	 */
	public ALoad(AttributeCode code, int index) throws InvalidInstructionInitialisationException {
		super(code, index);
