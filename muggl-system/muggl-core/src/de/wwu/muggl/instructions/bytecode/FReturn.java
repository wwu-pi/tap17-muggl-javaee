...
/**
 * Implementation of the instruction <code>freturn</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-03-26
 */
public class FReturn extends de.wwu.muggl.instructions.general.ReturnWithValue implements Instruction {
