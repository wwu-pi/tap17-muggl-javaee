...
/**
 * Implementation of the instruction <code>monitorexit</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2010-03-10
 */
public class Monitorexit extends Monitor implements Instruction {
	...
	public void execute(Frame frame) throws ExecutionException {
		try {
			...
			try {
				...
				// Handle directly, without wrapping the IllegalMonitorStateException.
				ExceptionHandler handler = new ExceptionHandler(frame, e.getWrappedException());
				try {
