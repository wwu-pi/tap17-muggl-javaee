...
/**
 * Implementation of the instruction <code>ifge</code>.
 *
...
public class Ifge extends If implements Instruction {
	 ...
	 */
	public Ifge(AttributeCode code, int lineNumber) throws InvalidInstructionInitialisationException {
	...
	/**
	 * Compare the value to 0. Return true if it is greater than or equal to it.
