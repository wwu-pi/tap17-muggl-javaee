...
import de.wwu.muggl.instructions.typed.CharacterInstruction;
import de.wwu.muggl.vm.classfile.ClassFile;

/**
 * Implementation of the instruction  <code>castore</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-03-25
 */
public class CAstore extends Astore implements Instruction {
