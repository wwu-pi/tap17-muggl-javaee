...
/**
 * Implementation of the instruction <code>fload</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-03-26
 */
public class FLoad extends Load implements Instruction {
	 ...
	 */
	public FLoad(AttributeCode code, int index) throws InvalidInstructionInitialisationException {
		super(code, index);
