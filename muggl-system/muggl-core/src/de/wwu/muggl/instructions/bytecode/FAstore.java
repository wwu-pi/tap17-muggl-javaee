...
/**
 * Implementation of the instruction <code>fastore</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-03-26
 */
public class FAstore extends Astore implements Instruction {
	...
	public byte[] getTypesPopped(ClassFile methodClassFile) {
		byte[] types = {ClassFile.T_FLOAT, ClassFile.T_INT, 0};
		return types;
	}
