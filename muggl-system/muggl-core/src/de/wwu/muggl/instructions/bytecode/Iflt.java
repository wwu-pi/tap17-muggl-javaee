...
/**
 * Implementation of the instruction <code>iflt</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2008-02-25
 */
public class Iflt extends If implements Instruction {
	 ...
	 */
	public Iflt(AttributeCode code, int lineNumber) throws InvalidInstructionInitialisationException {
	...
	/**
	 * Compare the value to 0. Return true if it is less than it.
	...
	protected ConstraintExpression getConstraintExpression(Term term1, Term term2) {
		return LessThan.newInstance(term1, term2);
	}
}
