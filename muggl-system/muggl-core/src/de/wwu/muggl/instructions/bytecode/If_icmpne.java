...
/**
 * Implementation of the instruction <code>if_icmpne</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2008-11-04
 */
public class If_icmpne extends If_icmp implements Instruction {
	 ...
	 */
	public If_icmpne(AttributeCode code, int lineNumber) throws InvalidInstructionInitialisationException {
