...
/**
 * Implementation of the instruction <code>lstore</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-03-27
 */
public class LStore extends Store implements Instruction {
	 ...
	 */
	public LStore(AttributeCode code, int index) throws InvalidInstructionInitialisationException {
		super(code, index);
