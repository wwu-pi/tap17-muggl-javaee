...
/**
 * Implementation of the instruction <code>f2l</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-03-26
 */
public class F2l extends Conversion implements Instruction {
	...
	public void executeSymbolically(Frame frame) {
		...
		Term newTerm = TypeCast.newInstance(oldTerm, oldTerm.getType(), Expression.LONG);
		stack.push(newTerm);
	}
