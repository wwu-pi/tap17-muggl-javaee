...
/**
 * Implementation of the instruction <code>if_icmplt</code>.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2008-11-04
 */
public class If_icmplt extends If_icmp implements Instruction {
	 ...
	 */
	public If_icmplt(AttributeCode code, int lineNumber) throws InvalidInstructionInitialisationException {
