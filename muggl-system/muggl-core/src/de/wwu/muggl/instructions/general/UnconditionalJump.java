...
/**
 * Abstract instruction with some concrete methods for unconditional jumping instructions.
 * Concrete instructions can be extended from this class.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2008-10-29
 */
public abstract class UnconditionalJump extends GeneralInstructionWithOtherBytes implements JumpAlways {
	 ...
	 */
	public UnconditionalJump(AttributeCode code) throws InvalidInstructionInitialisationException {
		super(code);
	}
