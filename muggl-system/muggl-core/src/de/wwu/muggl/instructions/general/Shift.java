...
/**
 * Abstract instruction with some concrete methods for shifting operations. Concrete
 * instructions can be extended from this class.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-03-23
 */
public abstract class Shift extends GeneralInstruction implements JumpNever, StackPop, StackPush {
