...
/**
 * {@link ReplacingInstruction} for <i>ldc2_w</i>. Executed once, it will store the executions results
 * and replace itself with {@link LdcQuick}.
 *
 * @author Tim Majchrzak
 * @version 1.0.0, 2009-11-24
 */
public class Ldc2_wReplacer extends Ldc2_w implements ReplacingInstruction {
	 ...
	 */
	public Ldc2_wReplacer(AttributeCode code) throws InvalidInstructionInitialisationException {
		super(code);
	}
