...
public class EntityDateObjectref extends Objectref implements Variable, ReferenceValue, Comparable {

	protected String name;
	protected Objectref referenceValue;
	
	public EntityDateObjectref(String name, Objectref referenceValue) {
	...
	public String toString() {
		return "EntityDateObjectref: [name="+this.name + " to object: " + this.referenceValue.getObjectId() +"]";
	}
