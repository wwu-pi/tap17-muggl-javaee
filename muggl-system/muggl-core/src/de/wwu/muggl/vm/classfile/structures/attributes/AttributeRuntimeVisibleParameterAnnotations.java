 ...
 */
public class AttributeRuntimeVisibleParameterAnnotations extends AttributeRuntimeParameterAnnotationsAbstract {
	 ...
	 */
	public AttributeRuntimeVisibleParameterAnnotations(ClassFile classFile, int attributeNameIndex)
			throws ClassFileException, IOException {
		super(classFile, attributeNameIndex, "attribute_runtime_visible_parameter_annotation",
