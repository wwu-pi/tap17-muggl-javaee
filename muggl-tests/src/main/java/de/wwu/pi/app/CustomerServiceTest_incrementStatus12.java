 ...
 * 
 * This file has been generated on Wednesday, 01 March, 2017 23:19.
 * 
 * @author Muggl 1.00 Alpha (unreleased)
 */
@RunWith(Arquillian.class)
public class CustomerServiceTest_incrementStatus12 extends AbstractCustomerServiceTest {
	@Inject
	...
	@Test public void testIncrementStatus1() throws Exception { 
		...
		long arg3 = 0L;
		/** SOLUTION 
		{SymbolicQueryResultList#670900267#idx-0.elementData.length=0, SymbolicQueryResultList#670900267.length=0, d.fastTime=0}
		  ***********************************/ 
	...
	@Test public void testIncrementStatus3() throws Exception { 
		...
		long arg3 = -50L;
		/** SOLUTION 
		{DATA#SymbolicQuery.158.element#0.id.value.element.0=35, DATA#SymbolicQuery.158.element#0.id.value.length=1, DATA#SymbolicQuery.158.element#0.name.value.element.0=35, DATA#SymbolicQuery.158.element#0.name.value.length=1, DATA#SymbolicQuery.158.element#0.status=0, SymbolicQuery.152.element#0.name.value.length=1, SymbolicQuery.152.element#0.price=1, SymbolicQuery.156.element#0.orderDate.fastTime=1, SymbolicQuery.158.element#0.id.value.element.0=35, SymbolicQuery.158.element#0.id.value.length=1, SymbolicQuery.158.element#0.id.value.length=1, SymbolicQuery.158.element#0.name.value.element.0=35, SymbolicQuery.158.element#0.name.value.length=1, SymbolicQuery.158.element#0.name.value.length=1, SymbolicQuery.158.element#0.status=0, SymbolicQuery.158.element#0.status=0, SymbolicQueryResultList#670900267#idx-0.elementData.length=1, SymbolicQueryResultList#670900267.length=1, d.fastTime=0, r=-50, s=1}
		  ***********************************/ 
		this.testedClass.incrementStatus(arg1, arg2, arg3);
		// check post-execution database state 
		de.wwu.pi.app.entities.Customer entity166_db = (de.wwu.pi.app.entities.Customer)em.find(de.wwu.pi.app.entities.Customer.class, customer1.getId());
