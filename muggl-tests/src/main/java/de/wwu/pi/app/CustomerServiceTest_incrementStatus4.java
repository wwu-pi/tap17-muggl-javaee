 ...
 * de.wwu.pi.app.ejb.CustomerService.incrementStatus(int s, java.util.Date d).
 ...
 * 
 * This file has been generated on Wednesday, 01 March, 2017 11:08.
 * 
 * @author Muggl 1.00 Alpha (unreleased)
 */
@RunWith(Arquillian.class)
public class CustomerServiceTest_incrementStatus4 extends AbstractCustomerServiceTest {
	@Inject
	...
	/**
	 * Run the tests on de.wwu.pi.app.ejb.CustomerService.incrementStatus(int s, java.util.Date d).
	 */
	@Test public void testIncrementStatus1() throws Exception { 
		...
		/** SOLUTION 
		{SymbolicQueryResultList#2016848912#idx-0.elementData.length=0, SymbolicQueryResultList#2016848912.length=0, d.fastTime=0}
		  ***********************************/ 
		this.testedClass.incrementStatus(arg1, arg2); // In this solution, not all parameters are used (int s is unused)., int s is unused).
	...
	@Test public void testIncrementStatus2() throws Exception { 
		...
		// generate object with id: de.wwu.pi.app.entities.OrderItem167
		de.wwu.pi.app.entities.OrderItem orderItem1 = new de.wwu.pi.app.entities.OrderItem();// object id: de.wwu.pi.app.entities.OrderItem167
		orderItem1.setPrice(10);
		orderItem1.setName("#");
		orderItem1.setOrder(customerOrder1);
		// generate object with id: de.wwu.pi.app.entities.OrderItem153
		de.wwu.pi.app.entities.OrderItem orderItem2 = new de.wwu.pi.app.entities.OrderItem();// object id: de.wwu.pi.app.entities.OrderItem153
		orderItem2.setPrice(10);
		orderItem2.setName("#");
		orderItem2.setOrder(customerOrder1);
		...
		java.util.Date arg2 = new java.util.Date(0);
		/** SOLUTION 
		{DATA#SymbolicQuery.158.element#0.id.value.element.0=35, DATA#SymbolicQuery.158.element#0.id.value.length=1, DATA#SymbolicQuery.158.element#0.name.value.element.0=35, DATA#SymbolicQuery.158.element#0.name.value.length=1, DATA#SymbolicQuery.158.element#0.status=0, SymbolicQuery.152.element#0.name.value.length=1, SymbolicQuery.152.element#0.price=1, SymbolicQuery.156.element#0.orderDate.fastTime=0, SymbolicQuery.158.element#0.id.value.element.0=35, SymbolicQuery.158.element#0.id.value.length=1, SymbolicQuery.158.element#0.id.value.length=1, SymbolicQuery.158.element#0.name.value.element.0=35, SymbolicQuery.158.element#0.name.value.length=1, SymbolicQuery.158.element#0.name.value.length=1, SymbolicQuery.158.element#0.status=0, SymbolicQuery.158.element#0.status=0, SymbolicQuery.166.element#0.name.value.length=1, SymbolicQuery.166.element#0.price=15, SymbolicQueryResultList#2016848912#idx-0.elementData.length=1, SymbolicQueryResultList#2016848912.length=1, d.fastTime=0, s=-50}
		  ***********************************/ 
		this.testedClass.incrementStatus(arg1, arg2);
		// expect 0 new entries in database:
		// check post-execution database state 
		de.wwu.pi.app.entities.Customer entity170_db = (de.wwu.pi.app.entities.Customer)em.find(de.wwu.pi.app.entities.Customer.class, customer1.getId());
		assertNotNull(entity170_db);
		assertEquals("#", entity170_db.getName());
		assertEquals("#", entity170_db.getId());
		assertEquals(0, entity170_db.getStatus());
	} 
	...
	@Test public void testIncrementStatus3() throws Exception { 
		...
		java.util.Date arg2 = new java.util.Date(0);
		/** SOLUTION 
		{DATA#SymbolicQuery.158.element#0.id.value.element.0=35, DATA#SymbolicQuery.158.element#0.id.value.length=1, DATA#SymbolicQuery.158.element#0.name.value.element.0=35, DATA#SymbolicQuery.158.element#0.name.value.length=1, DATA#SymbolicQuery.158.element#0.status=0, SymbolicQuery.152.element#0.name.value.length=1, SymbolicQuery.152.element#0.price=1, SymbolicQuery.156.element#0.orderDate.fastTime=0, SymbolicQuery.158.element#0.id.value.element.0=35, SymbolicQuery.158.element#0.id.value.length=1, SymbolicQuery.158.element#0.id.value.length=1, SymbolicQuery.158.element#0.name.value.element.0=35, SymbolicQuery.158.element#0.name.value.length=1, SymbolicQuery.158.element#0.name.value.length=1, SymbolicQuery.158.element#0.status=0, SymbolicQuery.158.element#0.status=0, SymbolicQuery.166.element#0.name.value.length=1, SymbolicQuery.166.element#0.price=15, SymbolicQueryResultList#2016848912#idx-0.elementData.length=1, SymbolicQueryResultList#2016848912.length=1, d.fastTime=0, s=1}
		  ***********************************/ 
		this.testedClass.incrementStatus(arg1, arg2);
		// expect 0 new entries in database:
		// check post-execution database state 
		...
		assertEquals("#", entity170_db.getName());
		assertEquals("#", entity170_db.getId());
		assertEquals(1, entity170_db.getStatus());
	} 
