 ...
 * 
 * This file has been generated on Wednesday, 15 February, 2017 10:04.
 * 
 * @author Muggl 1.00 Alpha (unreleased)
 */
@RunWith(Arquillian.class)
public class CustomerServiceTest_incrementStatus0 extends AbstractCustomerServiceTest {
	@Inject
	...
	@Test public void testIncrementStatus1() throws Exception { 
		...
		long arg3 = 0L;
		/** SOLUTION 
		{SymbolicQueryResultList#87753226#idx-0.elementData.length=0, SymbolicQueryResultList#87753226.length=0, d.fastTime=0}
		  ***********************************/ 
	...
	@Test public void testIncrementStatus2() throws Exception { 
		...
		utx.begin();
		em.joinTransaction();
		// generate object with id: de.wwu.pi.app.entities.CustomerOrder155
		de.wwu.pi.app.entities.CustomerOrder customerOrder1 = new de.wwu.pi.app.entities.CustomerOrder();// object id: de.wwu.pi.app.entities.CustomerOrder155
		java.util.Date date1 = new java.util.Date(0);// object id: java.util.Date165
		customerOrder1.setOrderDate(date1);
		de.wwu.pi.app.entities.Customer customer1 = new de.wwu.pi.app.entities.Customer();// object id: de.wwu.pi.app.entities.Customer157
		customer1.setName("#");
		customer1.setId("#");
		customer1.setStatus(0);
		customerOrder1.setCustomer(customer1);
		// generate object with id: de.wwu.pi.app.entities.Customer157
		...
		long arg3 = -50L;
		/** SOLUTION 
		{DATA#SymbolicQuery.156.element#0.id.value.element.0=35, DATA#SymbolicQuery.156.element#0.id.value.length=1, DATA#SymbolicQuery.156.element#0.name.value.element.0=35, DATA#SymbolicQuery.156.element#0.name.value.length=1, DATA#SymbolicQuery.156.element#0.status=0, SymbolicQuery.152.element#0.name.value.length=1, SymbolicQuery.152.element#0.price=1, SymbolicQuery.154.element#0.orderDate.fastTime=0, SymbolicQuery.156.element#0.id.value.element.0=35, SymbolicQuery.156.element#0.id.value.length=1, SymbolicQuery.156.element#0.id.value.length=1, SymbolicQuery.156.element#0.name.value.element.0=35, SymbolicQuery.156.element#0.name.value.length=1, SymbolicQuery.156.element#0.name.value.length=1, SymbolicQuery.156.element#0.status=0, SymbolicQuery.156.element#0.status=0, SymbolicQueryResultList#87753226#idx-0.elementData.length=1, SymbolicQueryResultList#87753226.length=1, d.fastTime=0, r=-50, s=-50}
		  ***********************************/ 
	...
	@Test public void testIncrementStatus3() throws Exception { 
		...
		long arg3 = -50L;
		/** SOLUTION 
		{DATA#SymbolicQuery.156.element#0.id.value.element.0=35, DATA#SymbolicQuery.156.element#0.id.value.length=1, DATA#SymbolicQuery.156.element#0.name.value.element.0=35, DATA#SymbolicQuery.156.element#0.name.value.length=1, DATA#SymbolicQuery.156.element#0.status=0, SymbolicQuery.152.element#0.name.value.length=1, SymbolicQuery.152.element#0.price=1, SymbolicQuery.154.element#0.orderDate.fastTime=0, SymbolicQuery.156.element#0.id.value.element.0=35, SymbolicQuery.156.element#0.id.value.length=1, SymbolicQuery.156.element#0.id.value.length=1, SymbolicQuery.156.element#0.name.value.element.0=35, SymbolicQuery.156.element#0.name.value.length=1, SymbolicQuery.156.element#0.name.value.length=1, SymbolicQuery.156.element#0.status=0, SymbolicQuery.156.element#0.status=0, SymbolicQueryResultList#87753226#idx-0.elementData.length=1, SymbolicQueryResultList#87753226.length=1, d.fastTime=0, r=-50, s=1}
		  ***********************************/ 
		this.testedClass.incrementStatus(arg1, arg2, arg3);
		// expect 0 new entries in database:
		// check post-execution database state 
